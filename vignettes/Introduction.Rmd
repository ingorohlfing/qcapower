...
qcapower(cases = 10, alt_hypo = 1, null_hypo = 0.8, sims = 10, perms = 1000)$power[1]  #Jus to confirm with Ingo, the comma was deleted here by me as I believe it was a typo leading to errors on all OS.
```
