...
The `R` package `qcapower` allows you to estimate power of a term generated in a Qualitative Comparative Analysis (QCA). A term can be a single (INUS) condition, a conjunction or a disjunction of conditions and conjunctions. This vignette introduces the package, its in-built functions and things you might want to do with the package output in addition to what the functions offers. At present, the package includes four functions:  
